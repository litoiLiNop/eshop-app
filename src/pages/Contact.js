            ...
            <div className="contact-inner-wrapper d-flex justify-content-between ">
              <div>
                ...
                <form action="" className="d-flex flex-column gap-15">
                  ...
                  <div>
                    <button className="button border-0">Soumettre</button>
                  </div>
                </form>
              </div>
              <div>
                  ...
                  <ul className="ps-0">
                    <li className="mb-3 d-flex gap-15 align-items-center">
                      ...
                      <address className="mb-0">
                        Hno:277 , Near village Esse , Ngousso, Omnisport,
                        Yaoundé
                      </address>
                    </li>
                    <li className="mb-3 d-flex gap-15 align-items-center">
                      <BiPhoneCall className="fs-5" />
                      <a href="tel:+91 8264954234">+237 674667234</a>
                    </li>
                    <li className="mb-3 d-flex gap-15 align-items-center">
                      <AiOutlineMail className="fs-5" />
                      <a href="mailto:litoilinop@gmail.com">
                        litoilinop@gmail.com
                      </a>
                    </li>
                    <li className="mb-3 d-flex gap-15 align-items-center">
                      <BiInfoCircle className="fs-5" />
                      <p className="mb-0">Lundi – Vendredi 10h – 19h</p>
                    </li>
                  </ul>
                </div>
              </div>

...
const OurStore = () => {
  ...
  return (
    <>
      <Meta title={"Boutique SantaLucia"} />
      ...
      <Container class1="store-wrapper home-wrapper-2 py-5">
        <div className="row">
          <div className="col-3">
            ...
            <div className="filter-card mb-3">
              <h3 className="filter-title">Meta-mots</h3>
              <div>
            ...
            <div className="filter-card mb-3">
              <h3 className="filter-title">article aléatoire</h3>
              <div>
                ...
                <div className="d-flex align-items-center gap-10">
                  ...
                  >
                    ...
                    <option value="created-ascending">
                      Date, ancienne à nlle
                    </option>
                    <option value="created-descending">
                      Date, nlle à ancienne
                    </option>
                  </select>
                </div>
                <div className="d-flex align-items-center gap-10">
